...
export default function Header() {
    return(
        <header className="flex flex-row fixed w-full top-0 left-0 z-50 items-center justify-between h-30 bg-white">
            <img src={'/FlokiaLogo1.svg'} alt='Flokia Logo' className="p-4 ml-8 w-[15vw] max-w-[180px]"/>
            <nav className="flex mr-8">
                <ul className="flex items-center gap-6 text-neutral-dark text-md">
